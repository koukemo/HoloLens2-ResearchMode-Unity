...
IL_0543:
		{
			...
			bool L_199;
			L_199 = MixedRealityToolkitVisualProfiler_get_ShouldShowProfiler_mDB1855AFF16D9214BC67C4C68A1FBA59DAC565F8(__this, /*hidden argument*/NULL);
			NullCheck(L_198);
			GameObject_SetActive_mCF1EEF2A314F3AE85DA581FF52EB06ACEF2FFF86(L_198, L_199, /*hidden argument*/NULL);
			// memoryStats.gameObject.SetActive(memoryStatsVisible);
			Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_200 = __this->get_memoryStats_37();
			NullCheck(L_200);
			GameObject_tC000A2E1A7CF1E10FD7BA08863287C072207C319 * L_201;
			L_201 = Component_get_gameObject_m55DC35B149AFB9157582755383BA954655FE0C5B(L_200, /*hidden argument*/NULL);
			bool L_202 = __this->get_memoryStatsVisible_20();
			NullCheck(L_201);
			GameObject_SetActive_mCF1EEF2A314F3AE85DA581FF52EB06ACEF2FFF86(L_201, L_202, /*hidden argument*/NULL);
...
IL_012b:
		{
			...
			V_8 = L_59;
			IL2CPP_LEAVE(0x13F, FINALLY_0130);
		}
	} // end try (depth: 1)
	catch(Il2CppExceptionWrapper& e)
	{
...
IL_013f:
	{
		// }
		Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  L_60 = V_8;
		return L_60;
	}
}
// UnityEngine.Quaternion Microsoft.MixedReality.Toolkit.Diagnostics.MixedRealityToolkitVisualProfiler::CalculateWindowRotation(UnityEngine.Transform)
...
IL_024d:
	...
	}
	{
		...
		bool L_168;
		L_168 = MixedRealityToolkitVisualProfiler_get_ShouldShowProfiler_mDB1855AFF16D9214BC67C4C68A1FBA59DAC565F8(__this, /*hidden argument*/NULL);
		NullCheck(L_167);
		GameObject_SetActive_mCF1EEF2A314F3AE85DA581FF52EB06ACEF2FFF86(L_167, L_168, /*hidden argument*/NULL);
		// memoryStats.gameObject.SetActive(memoryStatsVisible);
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_169 = __this->get_memoryStats_37();
		NullCheck(L_169);
		...
		bool L_171 = __this->get_memoryStatsVisible_20();
		NullCheck(L_170);
		GameObject_SetActive_mCF1EEF2A314F3AE85DA581FF52EB06ACEF2FFF86(L_170, L_171, /*hidden argument*/NULL);
		// }
		return;
	}
}
